!(function(t, e) {
	'object' == typeof exports && 'undefined' != typeof module
		? (module.exports = e())
		: 'function' == typeof define && define.amd ? define(e) : (t.Shuffle = e());
})(this, function() {
	'use strict';
	function t() {}
	function e() {}
	...
	function n(t, e) {
		...
		return (
			x || 'width' !== e
				? x ||
					'height' !== e ||
					(s += i(n.paddingTop) + i(n.paddingBottom) + i(n.borderTopWidth) + i(n.borderBottomWidth))
				: (s += i(n.paddingLeft) + i(n.paddingRight) + i(n.borderLeftWidth) + i(n.borderRightWidth)),
			s
		);
	}
	function s(t) {
						...
						t.sort(function(t, e) {
							...
							return void 0 === n && void 0 === s
								...
								: n < s || 'sortFirst' === n || 'sortLast' === s
									? -1
									: n > s || 'sortLast' === n || 'sortFirst' === s ? 1 : 0;
						}),
	...
	function d(t, e) {
		for (var i = h(t), n = 0, s = t.length; n < s; n++) if (t[n] >= i - e && t[n] <= i + e) return n;
		return 0;
	}
	function m(t) {
		for (
						...
						},
						{
							...
							value: function(t) {
								return 'string' == typeof t
									...
									: t && t.nodeType && 1 === t.nodeType ? t : t && t.jquery ? t[0] : null;
							}
						},
						{
							key: '_validateStyles',
						...
						},
						{
							...
							value: function(t, i) {
								...
								return Array.isArray(t)
									? this.options.filterMode === e.FilterMode.ANY ? t.some(n) : t.every(n)
									: o.includes(t);
							}
						},
						{
						...
						},
						{
							...
							value: function() {
								...
								i && t && this.isInitialized
									...
									: i
										? (this._styleImmediately(this._queue), this._dispatch(e.EventType.LAYOUT))
