$(document).ready(() => {
 ...
 /**
  ...
  //  let firstDayOnWeek = "2018-5-1";
   let firstDayOnWeek = firstDayOfWeekObj.getUTCFullYear() +"-" + (firstDayOfWeekObj.getUTCMonth() + 1) + "-" + firstDayOfWeekObj.getUTCDate();
   let endToday = todayObj.getUTCFullYear() +"-" + (todayObj.getUTCMonth() + 1) + "-" + todayObj.getUTCDate();
  PaginatedAjax.get(
    "https://139.59.80.139/api/v1/analytics/subscriptions",
    username,
    password,
    1,
...
/**
  ...
  todayObj = new Date();
  endToday = todayObj.getUTCFullYear() +"-" + (todayObj.getUTCMonth() + 1) + "-" + todayObj.getUTCDate();
 PaginatedAjax.get(
   "https://139.59.80.139/api/v1/analytics/subscriptions",
   username,
   password,
